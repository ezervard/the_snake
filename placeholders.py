...
pause_text = pygame.font.SysFont('Arial', 32).render('Pause', True, pygame.color.Color(59, 120, 37))
pause_info = pygame.font.SysFont('Arial', 24).render('press SPACE to continue', True, pygame.color.Color(59, 120, 37))
